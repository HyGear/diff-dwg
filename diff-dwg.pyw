...
class DiffApp(Frame):
    def __init__(self, master):
        ...
        Checkbutton(self, text = "Attempt image alignment                 ", variable=check, fg='black').grid(row = 1, column = 0, sticky='SE')
        Radiobutton(self, text = "Batch Drawing Comparison", variable=v, value="2", fg='black').grid(row = 2, column = 0, sticky='S')
