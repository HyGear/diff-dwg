...
class DiffApp(Frame):
    def __init__(self, master):
        ...
        status_lower = Message(self, textvariable=v_status_f, bd=1, relief=SUNKEN, anchor=W, width=330,
                               font=('arial', 8)).grid(row=3, column=0, sticky='WE')
...
def main():
    ...
    if size_check == 1:
        error_msg("Drawing Error",
                  "A temp drawing failed to delete or there was a size mismatch. Please check output results.")
